...
describe('Root component', () => {
  ...
  it('navigates to /login when Log In button is clicked', () => {
    ...
    expect(container.innerHTML).toMatch('<div class=\"css-xmmg5m\"><h1 class=\"chakra-heading css-p03q1r\">WIQ-EN2B</h1><p class=\"chakra-text css-0\">session.welcome</p><div class=\"chakra-stack css-gjlptk\"><button type=\"submit\" class=\"chakra-button custom-button effect1 css-1vdwnhw\" data-testid=\"Login\">common.login</button><p class=\"chakra-text css-0\">session.account <span class=\"chakra-link css-p03q1r\">session.clickHere</span></p></div></div>');
  });
