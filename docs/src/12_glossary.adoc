...
|DTO
|Data Transfer Object (DTO) is an object that carries data between processes. The data is transferred as simple data structures and is not an object with behavior.
|===
